...
def init_directories(postprocess_folder):
    if postprocess_folder == "all_products":
        directory_g1 = r'../postprocess_all_products/g1'
        directory_g2 = r'../postprocess_all_products/g2'
        directory_g3 = r'../postprocess_all_products/g3'
        directory_g4 = r'../postprocess_all_products/g4'

        directories = [directory_g1, directory_g2, directory_g3, directory_g4]

    elif postprocess_folder == "cluster_products":
        directory_g1 = r'../postprocess_cluster_products/g1'
        directory_g2 = r'../postprocess_cluster_products/g2'
        directory_g3 = r'../postprocess_cluster_products/g3'
        directory_g4 = r'../postprocess_cluster_products/g4'
...
def load_data_from_folder(directory_ldff, filename):
    ...
    panier_cstm = pd.read_csv(directory_ldff + '/' + filename + '/' + 'order_99999999.csv')
    ...
    dataset_test_to_add = dataset_test_to_add.sample(n=150)
    dataset_test = dataset_test.loc[dataset_test['store_id'] != 0].reset_index(drop=True)

    dataset_test = dataset_test.append(panier_cstm).reset_index(drop=True)
    ...
    df_X_test_to_add = df_X_test_to_add.sample(n=150)
    df_X_test = df_X_test.loc[df_X_test['store_id'] != 0].reset_index(drop=True)

    df_X_test = df_X_test.append(panier_cstm).reset_index(drop=True)
    ...
    dataset_test_diminue_to_add = dataset_test_diminue_to_add.sample(n=150)
    dataset_test_diminue = dataset_test_diminue.loc[dataset_test_diminue['store_id'] != 0].reset_index(drop=True)

    dataset_test_diminue = dataset_test_diminue.append(panier_cstm).reset_index(drop=True)
    ...
    return X_train, dataset_test2, y_train, y_test, moyenne_taille_paniers, df_X_test, dataset_test_diminue, y_test2
